...
export default ({ schedule, task }: Props) => {
    ...
    return (
        <div css={tw`sm:flex items-center p-3 sm:p-6 border-b border-gray-700`}>
            ...
            <div css={tw`flex-none sm:flex-1 w-full sm:w-auto overflow-x-auto`}>
                ...
                {task.payload && (
                    <div css={tw`md:ml-6 mt-2`}>
                        ...
                        <div
                            css={tw`font-mono bg-canvas border border-gray-700 rounded py-1 px-2 text-sm w-auto inline-block whitespace-pre-wrap break-all`}
                        >
                            {task.payload}
                        </div>
                    </div>
            ...
            <div css={tw`mt-3 sm:mt-0 flex items-center w-full sm:w-auto`}>
                {task.continueOnFailure && (
                    <div css={tw`mr-6`}>
                        <div css={tw`flex items-center px-2 py-1 bg-warning-500 text-canvas text-sm rounded-full`}>
                ...
                {task.sequenceId > 1 && task.timeOffset > 0 && (
                    <div css={tw`mr-6`}>
                        <div css={tw`flex items-center px-2 py-1 bg-raised text-gray-300 text-sm rounded-full`}>
                ...
                <Can action={'schedule.update'}>
                    <button
                        ...
                        css={tw`block text-sm p-2 text-gray-500 hover:text-gray-50 transition-colors duration-150 mr-4 ml-auto sm:ml-0`}
                ...
                <Can action={'schedule.update'}>
                    <button
                        ...
                        css={tw`block text-sm p-2 text-gray-500 hover:text-danger-400 transition-colors duration-150`}
