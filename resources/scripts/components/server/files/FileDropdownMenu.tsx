...
const StyledRow = styled.div<{ $danger?: boolean }>`
    ${tw`p-2 flex items-center rounded cursor-pointer text-gray-300 transition-colors duration-150`};
        ...
        <>
            ...
            <DropdownMenu
                ...
                renderToggle={(onClick) => (
                    <div css={tw`px-4 py-2 text-gray-500 hover:text-gray-50 cursor-pointer`} onClick={onClick}>
