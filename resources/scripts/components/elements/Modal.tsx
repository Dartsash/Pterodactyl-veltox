                ...
                <ModalContainer alignTop={top}>
                    ...
                    {showSpinnerOverlay && (
                        <Fade timeout={150} appear in>
                            <div
                                css={tw`absolute w-full h-full rounded-lg flex items-center justify-center`}
                                style={{ background: 'rgba(11, 14, 20, 0.6)', zIndex: 9999 }}
                            >
                                <Spinner />
                            </div>
                        </Fade>
                    ...
                    <div
                        css={tw`bg-surface border border-gray-700 p-3 sm:p-4 md:p-6 rounded-lg shadow-lg overflow-y-scroll transition-all duration-150`}
                    >
                        {children}
                    </div>
                </ModalContainer>
