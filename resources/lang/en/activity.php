...
return [
    ...
    'server' => [
        ...
        'player' => [
            'add' => 'Added :target to :list',
            'remove' => 'Removed :target from :list',
        ],
        'mod' => [
            'install' => 'Installed mod :mod (:version)',
            'enable' => 'Enabled mod :mod',
            'disable' => 'Disabled mod :mod',
            'delete' => 'Deleted mod :mod',
        ],
        'properties' => [
            'update' => 'Updated the server configuration',
        ],
        'console' => [
