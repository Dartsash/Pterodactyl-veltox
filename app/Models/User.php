    ...
    Identifiable
{
    ...
    public function toVueObject(): array
    {
        return Collection::make($this->toArray())->except(['id', 'external_id'])
            ->merge([
                ...
                // Permission Management addon: lets the client show the admin
                // cog for staff members holding a role.
                'staff_admin' => app(\Pterodactyl\Services\Addons\StaffPermissionService::class)->canAccessAdmin($this),
            ])
            ->toArray();
    }
    ...
    /**
     * The staff role granting partial admin access, see the "Permission
     * Management" addon. Null for regular users and root administrators.
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo<\Pterodactyl\Models\StaffRole, $this>
     */
