...
class Permission extends Model
{
    ...
    public const ACTION_ADDON_READ = 'addon.read';
    public const ACTION_ADDON_INSTALL = 'addon.install';
    ...
    protected static array $permissions = [
        ...
        'addon' => [
            'description' => 'Permissions that control a user\'s access to the addon marketplace for this server.',
            'keys' => [
                'read' => 'Allows a user to browse the addon marketplace and view installed addons.',
                'install' => 'Allows a user to install and remove addons for this server.',
            ],
        ],
        'activity' => [
