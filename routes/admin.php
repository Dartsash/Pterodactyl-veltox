...
Route::group(['prefix' => 'addons'], function () {
    ...
    Route::get('/plugin-manager', [Admin\AddonController::class, 'manage'])->name('admin.addons.manage');
    Route::get('/startup-editor', [Admin\AddonController::class, 'startupEditor'])->name('admin.addons.startup');
    Route::get('/config-editor', [Admin\AddonController::class, 'configEditor'])->name('admin.addons.config');
    Route::get('/announcement', [Admin\AddonController::class, 'announcement'])->name('admin.addons.announcement');
    Route::get('/versions', [Admin\AddonController::class, 'versions'])->name('admin.addons.versions');
    Route::post('/versions', [Admin\AddonController::class, 'updateVersions'])->name('admin.addons.versions.update');
    Route::get('/players', [Admin\AddonController::class, 'players'])->name('admin.addons.players');
    Route::post('/players', [Admin\AddonController::class, 'updatePlayers'])->name('admin.addons.players.update');
    Route::get('/mods', [Admin\AddonController::class, 'mods'])->name('admin.addons.mods');
    Route::post('/mods', [Admin\AddonController::class, 'updateMods'])->name('admin.addons.mods.update');

    // Permission Management addon. Root administrators only, enforced in AdminAuthenticate.
    Route::get('/permissions', [Admin\StaffRoleController::class, 'index'])->name('admin.addons.permissions');
    Route::get('/permissions/new', [Admin\StaffRoleController::class, 'create'])->name('admin.addons.permissions.new');
    Route::get('/permissions/view/{role}', [Admin\StaffRoleController::class, 'view'])->name('admin.addons.permissions.view');
    Route::post('/permissions/new', [Admin\StaffRoleController::class, 'store']);
    Route::post('/permissions/toggle', [Admin\StaffRoleController::class, 'toggle'])->name('admin.addons.permissions.toggle');
    Route::patch('/permissions/view/{role}', [Admin\StaffRoleController::class, 'update']);
    Route::delete('/permissions/view/{role}', [Admin\StaffRoleController::class, 'delete']);
    Route::get('/view/{addon}', [Admin\AddonController::class, 'view'])->name('admin.addons.view');

    Route::post('/', [Admin\AddonController::class, 'store']);
    Route::post('/startup-editor', [Admin\AddonController::class, 'updateStartupEditor'])->name('admin.addons.startup.update');
    Route::post('/config-editor', [Admin\AddonController::class, 'updateConfigEditor'])->name('admin.addons.config.update');
    Route::post('/announcement', [Admin\AddonController::class, 'updateAnnouncement'])->name('admin.addons.announcement.update');
    Route::post('/managers/{manager}/toggle', [Admin\AddonController::class, 'toggleManager'])->name('admin.addons.manager.toggle');
    Route::post('/{addon}/toggle', [Admin\AddonController::class, 'toggle'])->name('admin.addons.toggle');

    Route::patch('/view/{addon}', [Admin\AddonController::class, 'update']);

    Route::delete('/view/{addon}', [Admin\AddonController::class, 'delete']);
});
